...
public class BalanceUtils {
    ...
    public static IncomeData getIncomeData(AgeData startAge, AgeData endAge, double interest, double startBalance, int withdrawMode, double withdrawAmount) {
        ...
        if(numMonths == 0) {
            return new IncomeData(age, getMonthlyAmount(balance, withdrawMode, withdrawAmount),  startBalance, 0, null);
        }
        ...
        return new IncomeData(age, monthlyAmount,  balance, 0, null);
    }
}
